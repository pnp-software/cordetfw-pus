...
if [ "$FWPROFILE" == "YES" ]
  then
    ...
    cp $EDITOR_PATH/CrPsCmd17s3Prgr/*.h ./src/TstService
    cp $EDITOR_PATH/CrPsCmd17s3Prgr/*.c ./src/TstService
    cp $EDITOR_PATH/CrPsCmd17s3Start/*.h ./src/TstService
    cp $EDITOR_PATH/CrPsCmd17s3Start/*.c ./src/TstService
