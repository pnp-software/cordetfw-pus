...
#define CR_FW_OUTCMP_INIT_KIND_DESC {\
   ...
   {1, 2, 0, 2, 29, &CrPsVerFailedAccRepEnableCheck, &CrFwSmCheckAlwaysTrue, \
      &CrFwSmCheckAlwaysFalse, &CrFwSmEmptyAction, &CrFwOutCmpDefSerialize}, \
   {1, 3, 0, 2, 20, &CrPsVerSuccStartRepEnableCheck, &CrFwSmCheckAlwaysTrue, \
      &CrFwSmCheckAlwaysFalse, &CrFwSmEmptyAction, &CrFwOutCmpDefSerialize}, \
   {1, 4, 0, 2, 29, &CrPsVerFailedStartRepEnableCheck, &CrFwSmCheckAlwaysTrue, \
      &CrFwSmCheckAlwaysFalse, &CrFwSmEmptyAction, &CrFwOutCmpDefSerialize}, \
   {1, 5, 0, 2, 22, &CrPsVerSuccPrgrRepEnableCheck, &CrFwSmCheckAlwaysTrue, \
      &CrFwSmCheckAlwaysFalse, &CrFwSmEmptyAction, &CrFwOutCmpDefSerialize}, \
   {1, 6, 0, 2, 31, &CrPsVerFailedPrgrRepEnableCheck, &CrFwSmCheckAlwaysTrue, \
      &CrFwSmCheckAlwaysFalse, &CrFwSmEmptyAction, &CrFwOutCmpDefSerialize}, \
   {1, 7, 0, 2, 20, &CrPsVerSuccTermRepEnableCheck, &CrFwSmCheckAlwaysTrue, \
      &CrFwSmCheckAlwaysFalse, &CrFwSmEmptyAction, &CrFwOutCmpDefSerialize}, \
   {1, 8, 0, 2, 29, &CrPsVerFailedTermRepEnableCheck, &CrFwSmCheckAlwaysTrue, \
      &CrFwSmCheckAlwaysFalse, &CrFwSmEmptyAction, &CrFwOutCmpDefSerialize}, \
   {1, 10, 0, 2, 25, &CrPsVerFailedRoutingRepEnableCheck, &CrFwSmCheckAlwaysTrue, \
      &CrFwSmCheckAlwaysFalse, &CrFwSmEmptyAction, &CrFwOutCmpDefSerialize}, \
