...
/**
 * Identifier for sub-type of packet: EnbId in domain Evt (Command to enable
 * generation of a list of event identifiers)
 */
#define EVTENBID_STYPE (5)
/**
 * Identifier for sub-type of packet: DisIdCmd in domain Evt (Command to
 * disable generation of a list of event identifiers)
 */
#define EVTDISIDCMD_STYPE (6)
/**
 * Identifier for sub-type of packet: RepDisIdCmd in domain Evt (This command
 * triggers the generation of a (5,8) report holding the list of disabled
 * event identifiers)
 */
#define EVTREPDISIDCMD_STYPE (7)
/**
 * Identifier for sub-type of packet: DisIdRep in domain Evt (Report generated
