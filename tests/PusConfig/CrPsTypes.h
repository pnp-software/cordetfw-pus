...
/**
 * Definition of type "CrFwDestSrc_t".
 */
typedef uint8_t CrFwDestSrc_t;

/**
 * Definition of type "CrFwTimeStamp_t".
 */
typedef uint48_t CrFwTimeStamp_t;
...
/**
 * Definition of type "CrFwTimeCyc_t".
 */
typedef uint16_t CrFwTimeCyc_t;
...
/**
 * Definition of type "CrFwBool_t".
 */
typedef uint8_t CrFwBool_t;
...
/**
 * Definition of type "CrFwTime_t".
 */
typedef uint32_t CrFwTime_t;
