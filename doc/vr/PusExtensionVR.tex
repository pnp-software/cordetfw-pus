...
\newpage
\pnpcsvtable{|l|c|>{\raggedright\arraybackslash}p{7cm}|>{\raggedright\arraybackslash}p{9cm}|}{Traceability of Adaptation Points to Implementation}{tab:APTrace}{Req. ID & Origin & Requirement Text & Implementation }{../pus/PusExtensionAP.csv}{\Category-\Id & \Origin & \AP & \Implementation}
