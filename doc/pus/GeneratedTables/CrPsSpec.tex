...
\def \printInCmdEvtEnbIdSpec#1 {
\begin{pnptable}{#1}{Specification of EvtEnbId Component}{tab:InCmdEvtEnbIdSpec}{Name & EvtEnbId(5,5)}
...
\def \printInCmdEvtDisIdCmdSpec#1 {
\begin{pnptable}{#1}{Specification of EvtDisIdCmd Component}{tab:InCmdEvtDisIdCmdSpec}{Name & EvtDisIdCmd(5,6)}
...
\def \printInCmdEvtRepDisIdCmdSpec#1 {
\begin{pnptable}{#1}{Specification of EvtRepDisIdCmd Component}{tab:InCmdEvtRepDisIdCmdSpec}{Name & EvtRepDisIdCmd(5,7)}
...
\def \printOutCmpEvtDisIdRepSpec#1 {
\begin{pnptable}{#1}{Specification of EvtDisIdRep Component}{tab:OutCmpEvtDisIdRepSpec}{Name & EvtDisIdRep(5,8)}
