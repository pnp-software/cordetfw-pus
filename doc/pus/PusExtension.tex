...
The ground can choose whether or not an event is associated to a monitor and it can choose the identifier of the event but the layout of the event must be like that of the EVT\_MON\_* events.
