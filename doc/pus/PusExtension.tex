...
\pnpcsvtable{|c|>{\raggedright\arraybackslash}p{9cm}|>{\raggedright\arraybackslash}p{8cm}|}{Error Reports}{tab:evtRep}{Name & Description & Parameters}{./GeneratedTables/PUSExtensionErrRepCodet.csv}{\texttt{\Name} & \Description & \ErrRepData}
