...
Data pool items may have a multiplicity greater than 1 (array-like data items). In this case, monitoring is done on the elements of the data item array.
...
\item Expected Value Monitor Procedure: verifies whether the monitored parameter has a pre-defined value. See figure \ref{fig:MonExpValPr}.
