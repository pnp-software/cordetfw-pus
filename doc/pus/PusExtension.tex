...
\item The application configures the component with the destination and with any data which are attached to the event 
...
The mapping of event identifiers to their severity level is an application-level decision and the PUS Extension only defines an interface through which the framework may retrieve the severity level of a given event identifier (adaptation point TBD).
