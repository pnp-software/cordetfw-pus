...
Data pool items may have a multiplicity greater than 1. Monitoring is only possible for data pool items with a unitary multiplicity (i.e. for non-array data pool items).
