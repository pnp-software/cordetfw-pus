...
\begin{crAp}{S03}{Adaptation Points for Service 3 (Housekeeping)}
\end{crAp}
...
\newpage
\printOutCmpEvtRepaRepSpec{|c|p{10cm}|}
\printOutCmpEvtRepbRepSpec{|c|p{10cm}|}
\newpage
\printOutCmpEvtRepcRepSpec{|c|p{10cm}|}
\printOutCmpEvtRepdRepSpec{|c|p{10cm}|}
\newpage
