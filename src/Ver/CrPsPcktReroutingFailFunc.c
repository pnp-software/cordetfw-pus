 ...
 * @ingroup man_ver
 *
 * @brief Implementation for the actions and guards in the Packet Re-Routing Failure Procedure.
 * This procedure is created and configured in module CrPsPcktReroutingFail.h.
