 ...
 * @ingroup man_ver
 *
 * @brief Implementation for the actions and guards in the Command Progress Failure Procedure.
 * This procedure is created and configured in module CrPsCmdPrgrFail.h.
