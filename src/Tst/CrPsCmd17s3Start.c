 ...
 */
static FwPrBool_t code61425(FwPrDesc_t prDesc)
{	(void)prDesc;
	return 1;
}
 ...
 * @return 1 if the guard is fulfilled, otherwise 0.
 */
static FwPrBool_t code29210(FwPrDesc_t prDesc)
{	(void)prDesc;
	return 1;
}
 ...
 * @return 1 if the guard is fulfilled, otherwise 0.
 */
static FwPrBool_t code9027(FwPrDesc_t prDesc)
{	(void)prDesc;
	return 1;
}
...
FwPrDesc_t CrPsCmd17s3StartCreate(void* prData)
{
	...
	FwPrAddFlowDecToAct(prDesc, DECISION1, CrPsCmd17s3Start_N9, &code61425);
	...
	FwPrAddFlowDecToAct(prDesc, DECISION2, CrPsCmd17s3Start_N8, &code29210);
	...
	FwPrAddFlowDecToAct(prDesc, DECISION3, CrPsCmd17s3Start_N10, &code9027);
