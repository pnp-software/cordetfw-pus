 ...
 * @ingroup man_tst
 *
 * @brief Define functions implementing the Progress Action Procedure
 * of the command (17,3) of <code>CrPsCmd17s3Prgr.h</code>.
 * This procedure is created and configured in module CrPsCmd17s3Prgr.h.
