 ...
 * configured to have the same destination as the source of the (3,9) command
 * and then it is loaded in the OutLoader and the outcome of the action is set
 * to 'success';
...
void CrPsInCmdHkRepStructHkCmdProgressAction(FwSmDesc_t smDesc) {
    ...
    if (rdlPos < 0) {
      ...
      if (repStruct == NULL) {
        ...
        CrFwOutCmpSetDest(repStruct, src5s7);
