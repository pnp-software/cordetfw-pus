...
/**
 * Acceptance check of TC(255,1) DumSample1.
 ...
 */
CrFwBool_t CrPsDumSample1AcceptanceCheck(FwPrDesc_t prDesc);
 ...
 */
CrFwBool_t CrPsDumSample1ReadyCheck(FwSmDesc_t smDesc);
 ...
 * @param smDesc The state machine descriptor.
 */
void CrPsDumSample1StartAction(FwSmDesc_t smDesc);
 ...
 * @param smDesc The state machine descriptor.
 */
void CrPsDumSample1ProgressAction(FwSmDesc_t smDesc);
 ...
 * @param smDesc The state machine descriptor.
 */
void CrPsDumSample1TerminationAction(FwSmDesc_t smDesc);
 ...
 * @param smDesc The state machine descriptor.
 */
void CrPsDumSample1AbortAction(FwSmDesc_t smDesc);
