 ...
 */
static FwPrBool_t code49846(FwPrDesc_t prDesc)
{
	return 1;
}
 ...
 * @return 1 if the guard is fulfilled, otherwise 0.
 */
static FwPrBool_t code21420(FwPrDesc_t prDesc)
{
	return 1;
}
 ...
 * @return 1 if the guard is fulfilled, otherwise 0.
 */
static FwPrBool_t code9374(FwPrDesc_t prDesc)
{
	return 1;
}
...
FwPrDesc_t CrPsCmd17s3StartCreate(void* prData)
{
	...
	FwPrAddFlowDecToAct(prDesc, DECISION1, CrPsCmd17s3Start_N9, &code49846);
	...
	FwPrAddFlowDecToAct(prDesc, DECISION2, CrPsCmd17s3Start_N8, &code21420);
	...
	FwPrAddFlowDecToAct(prDesc, DECISION3, CrPsCmd17s3Start_N10, &code9374);
