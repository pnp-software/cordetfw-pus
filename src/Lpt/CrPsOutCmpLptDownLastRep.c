 ...
 */
CrFwBool_t CrPsOutCmpLptDownLastRepEnableCheck(FwSmDesc_t smDesc)
{
   CRFW_UNUSED(smDesc);
   DBG("CrPsOutCmpLptDownLastRepEnableCheck");
   return 1;
}
 ...
 * @param smDesc The state machine descriptor.
 */
void CrPsOutCmpLptDownLastRepUpdateAction(FwSmDesc_t smDesc)
{
   CRFW_UNUSED(smDesc);
   DBG("CrPsOutCmpLptDownLastRepUpdateAction");
   return ;
}
