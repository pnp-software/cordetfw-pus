 ...
 * @ingroup gen_cfw
 *
 * Implementation of TC(12,20) MonDisFuncMonDefCmd as an incoming command.
 *
...
#include "CrPsInCmdMonDisFuncMonDefCmd.h"
 ...
 */
void CrPsInCmdMonDisFuncMonDefCmdStartAction(FwSmDesc_t smDesc)
{
   CRFW_UNUSED(smDesc);
   DBG("CrPsInCmdMonDisFuncMonDefCmdStartAction");
   return ;
}
 ...
 * @param smDesc The state machine descriptor.
 */
void CrPsInCmdMonDisFuncMonDefCmdProgressAction(FwSmDesc_t smDesc)
{
   CRFW_UNUSED(smDesc);
   DBG("CrPsInCmdMonDisFuncMonDefCmdProgressAction");
   return ;
}
