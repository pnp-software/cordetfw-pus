 ...
 *
 * @note This file was generated on 2018-09-22 13:45:19
...
typedef struct {
    ...
    */
   CrFwProgressStepId_t stepPrgrFailed;
} DpVerVars_t;

extern DpVerVars_t dpVerVars;

/**
 * Get the value of the data pool item failCode (Verification Failure Code)
 * @return The value of data pool item failCode
 */
static inline CrPsFailCode_t getDpVerFailCode() {
   return dpVerVars.failCode;
}

/**
 * Set the value of the data pool item failCode (Verification Failure Code)
 * @param failCode The value to be stored into the data pool item failCode.
 */
static inline void setDpVerFailCode(CrPsFailCode_t failCode) {
   dpVerVars.failCode = failCode;
}
...
/**
 * Get the value of the data pool item failData (Verification Failure Data
 * (data item of fixed size but variable meaning))
 * @return The value of data pool item failData
 */
static inline CrPsFailData_t getDpVerFailData() {
   return dpVerVars.failData;
}

/**
 * Set the value of the data pool item failData (Verification Failure Data
 * (data item of fixed size but variable meaning))
 * @param failData The value to be stored into the data pool item failData.
 */
static inline void setDpVerFailData(CrPsFailData_t failData) {
   dpVerVars.failData = failData;
}
 ...
 */
static inline CrFwProgressStepId_t getDpVerStepPrgrFailed() {
 ...
 * stepPrgrFailed.
 */
static inline void setDpVerStepPrgrFailed(CrFwProgressStepId_t stepPrgrFailed) {
