...
/**
 * Get the value of the datapool item failCodeAccFailed (Failure code of last
...
/**
 * Set the value of the datapool item failCodeAccFailed (Failure code of last
 * command which failed its Acceptance)
...
/**
 * Get the value of the datapool item failCodePrgrFailed (Failure code of last
...
/**
 * Set the value of the datapool item failCodePrgrFailed (Failure code of last
 * command which failed its Progress Check)
...
/**
 * Get the value of the datapool item failCodeStartFailed (Failure code of
...
/**
 * Set the value of the datapool item failCodeStartFailed (Failure code of
 * last command which failed its Start Check)
...
/**
 * Get the value of the datapool item failCodeTermFailed (Failure code of last
 * command which failed its Termination)
...
/**
 * Set the value of the datapool item failCodeTermFailed (Failure code of last
 * command which failed its Termination)
...
/**
 * Get the value of the datapool item invDestRerouting (Destination of last
...
/**
 * Set the value of the datapool item invDestRerouting (Destination of last
 * command for which re-routing failed)
...
/**
 * Get the value of the datapool item nOfAccFailed (Number of commands which
...
/**
 * Set the value of the datapool item nOfAccFailed (Number of commands which
 * have failed their acceptance check)
...
/**
 * Get the value of the datapool item nOfPrgrFailed (Number of commands which
 * have failed their Progress Check)
...
/**
 * Set the value of the datapool item nOfPrgrFailed (Number of commands which
 * have failed their Progress Check)
...
/**
 * Get the value of the datapool item nOfReroutingFailed (Number of commands
...
/**
 * Set the value of the datapool item nOfReroutingFailed (Number of commands
 * for which re-routing failed)
...
/**
 * Get the value of the datapool item nOfStartFailed (Number of commands which
 * have failed their Start Check since)
...
/**
 * Set the value of the datapool item nOfStartFailed (Number of commands which
 * have failed their Start Check since)
...
/**
 * Get the value of the datapool item nOfTermFailed (Number of commands which
 * have failed their Termination)
...
/**
 * Set the value of the datapool item nOfTermFailed (Number of commands which
 * have failed their Termination)
...
/**
 * Get the value of the datapool item pcktIdAccFailed (Packet identifier of
 * last command which failed its Acceptance)
...
/**
 * Set the value of the datapool item pcktIdAccFailed (Packet identifier of
 * last command which failed its Acceptance)
...
/**
 * Get the value of the datapool item pcktIdPrgrFailed (Packet identifier of
 * last command which failed its Progress)
...
/**
 * Set the value of the datapool item pcktIdPrgrFailed (Packet identifier of
 * last command which failed its Progress)
...
/**
 * Get the value of the datapool item pcktIdReroutingFailed (Packet identifier
 * of last command for which re-routing failed)
...
/**
 * Set the value of the datapool item pcktIdReroutingFailed (Packet identifier
 * of last command for which re-routing failed)
...
/**
 * Get the value of the datapool item pcktIdStartFailed (Packet identifier of
 * last command which failed its Start Check)
...
/**
 * Set the value of the datapool item pcktIdStartFailed (Packet identifier of
 * last command which failed its Start Check)
...
/**
 * Get the value of the datapool item pcktIdTermFailed (Packet identifier of
...
/**
 * Set the value of the datapool item pcktIdTermFailed (Packet identifier of
 * last command which failed its Termination)
...
/**
 * Get the value of the datapool item stepPrgrFailed (Step identifier of last
 * command which failed its Progress Check)
...
/**
 * Set the value of the datapool item stepPrgrFailed (Step identifier of last
 * command which failed its Progress Check)
...
/**
 * Get the value of the datapool item verFailCode (Verification Failure Code)
...
/**
 * Set the value of the datapool item verFailCode (Verification Failure Code)
...
/**
 * Get the value of the datapool item verFailData (Verification Failure Data
...
/**
 * Set the value of the datapool item verFailData (Verification Failure Data
 * (data item of fixed size but variable meaning))
