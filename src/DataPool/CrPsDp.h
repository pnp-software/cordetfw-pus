...
enum {
   ...
   DpIdfailCode = 66,
   DpIdfailCodeAccFailed = 67,
   DpIdfailCodePrgrFailed = 68,
   DpIdfailCodeStartFailed = 69,
   DpIdfailCodeTermFailed = 70,
   DpIdfailData = 71,
   DpIdinvDestRerouting = 72,
   DpIdnOfAccFailed = 73,
   DpIdnOfPrgrFailed = 74,
   DpIdnOfReroutingFailed = 75,
   DpIdnOfStartFailed = 76,
   DpIdnOfTermFailed = 77,
   DpIdpcktIdAccFailed = 78,
   DpIdpcktIdPrgrFailed = 79,
   DpIdpcktIdReroutingFailed = 80,
   DpIdpcktIdStartFailed = 81,
   DpIdpcktIdTermFailed = 82,
   DpIdstepPrgrFailed = 83
};
