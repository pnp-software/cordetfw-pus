...
/**
 * Get the value of the datapool item AreYouAliveTimeOut (Time-out for the
...
/**
 * Set the value of the datapool item AreYouAliveTimeOut (Time-out for the
 * Are-You-Alive Test initiated in response to an On-Board Connection Test)
...
/**
 * Get the datapool array OnBoardConnectDestLst (Identifiers of target
...
/**
 * Get the value of the i-th element in the datapool array
...
/**
 * Set the value of the i-th element in the datapool array
 * OnBoardConnectDestLst (Identifiers of target applications for an
 * On-Board-Connection Test)
 * @param i Index variable
...
/**
 * Get the value of the datapool item AreYouAliveSrc (Source of the latest
...
/**
 * Set the value of the datapool item AreYouAliveSrc (Source of the latest
 * (17,2) report received in response to a (17,1) command triggered by a
 * (17,3) command)
...
/**
 * Get the value of the datapool item AreYouAliveStart (Time when the
...
/**
 * Set the value of the datapool item AreYouAliveStart (Time when the
 * Are-You-Alive Test is started in response to an On-Board Connection Test)
...
/**
 * Get the value of the datapool item OnBoardConnectDest (Destination of the
...
/**
 * Set the value of the datapool item OnBoardConnectDest (Destination of the
 * (17,1) triggered by a (17,3) command)
