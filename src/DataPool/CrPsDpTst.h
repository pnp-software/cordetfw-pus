...
typedef struct {
    ...
    * Connection Test
    */
   Time_t AreYouAliveTimeOut;
   /**
    * Identifiers of target applications for an On-Board-Connection Test
    */
   DestSrc_t OnBoardConnectDestLst[TST_N_DEST];
} DpTstParams_t;
 ...
 */
static inline Time_t getDpAreYouAliveTimeOut()
{
 ...
 * AreYouAliveTimeOut.
 */
static inline void setDpAreYouAliveTimeOut(Time_t AreYouAliveTimeOut)
{
 ...
 */
static inline DestSrc_t* getDpOnBoardConnectDestLstArray()
{
 ...
 */
static inline DestSrc_t getDpOnBoardConnectDestLstItem(int i)
{
 ...
 */
static inline void setDpOnBoardConnectDestLstItem(int i, DestSrc_t OnBoardConnectDestLst)
{
 ...
 */
static inline DestSrc_t getDpAreYouAliveSrc()
{
 ...
 * AreYouAliveSrc.
 */
static inline void setDpAreYouAliveSrc(DestSrc_t AreYouAliveSrc)
{
 ...
 */
static inline Time_t getDpAreYouAliveStart()
{
 ...
 * AreYouAliveStart.
 */
static inline void setDpAreYouAliveStart(Time_t AreYouAliveStart)
{
 ...
 */
static inline DestSrc_t getDpOnBoardConnectDest()
{
 ...
 * OnBoardConnectDest.
 */
static inline void setDpOnBoardConnectDest(DestSrc_t OnBoardConnectDest)
{
