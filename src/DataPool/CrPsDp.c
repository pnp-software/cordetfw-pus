...
/**
 * Structure to hold the location and size information of a data pool entry.
 */
typedef struct _DpMetaInfoEntry_t {
   /**
    * The address of the data pool entry.
    */
   void* addr;
   /**
    * The length in bytes of the data pool entry.
    */
   size_t length;
   /**
...
static DpMetaInfoEntry_t dpMetaInfoVars[] = {
   ...
   {(void*)&dpVerVars.failCode, sizeof(dpVerVars.failCode), 1, sizeof(dpVerVars.failCode)},
   ...
   {(void*)&dpVerVars.failData, sizeof(dpVerVars.failData), 1, sizeof(dpVerVars.failData)},
