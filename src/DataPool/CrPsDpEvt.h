...
/**
 * Get the datapool array isEidEnabled (Enable status of the event
 * identifiers)
 * @return The datapool array isEidEnabled
 */
static inline CrFwBool_t* getDpisEidEnabledArray() {
   return &dpEvtVars.isEidEnabled[0];
}

/**
 * Get the value of the i-th element in the datapool array isEidEnabled
 * (Enable status of the event identifiers)
 * @param i Index variable
 * @return The i-th element in the datapool array isEidEnabled
 */
static inline CrFwBool_t getDpisEidEnabledItem(int i) {
   return dpEvtVars.isEidEnabled[i];
}

/**
 * Set the value of the i-th element in the datapool array isEidEnabled
 * (Enable status of the event identifiers)
 * @param i Index variable
 * @param isEidEnabled The value to be stored into the i-th element of
 * datapool array isEidEnabled.
 */
static inline void setDpisEidEnabledItem(int i, CrFwBool_t isEidEnabled) {
   dpEvtVars.isEidEnabled[i] = isEidEnabled;
}

/**
 * Get the value of the datapool item lastEvtEid_1 (Event identifier of the
 * last generated level 1 event report)
 * @return The value of datapool item lastEvtEid_1
 */
static inline CrPsEvtId_t getDplastEvtEid_1() {
   return dpEvtVars.lastEvtEid_1;
}

/**
 * Set the value of the datapool item lastEvtEid_1 (Event identifier of the
 * last generated level 1 event report)
 * @param lastEvtEid_1 The value to be stored into the datapool item
 * lastEvtEid_1.
 */
static inline void setDplastEvtEid_1(CrPsEvtId_t lastEvtEid_1) {
   dpEvtVars.lastEvtEid_1 = lastEvtEid_1;
}

/**
 * Get the value of the datapool item lastEvtEid_2 (Event identifier of the
 * last generated level 2 event report)
 * @return The value of datapool item lastEvtEid_2
 */
static inline CrPsEvtId_t getDplastEvtEid_2() {
   return dpEvtVars.lastEvtEid_2;
}

/**
 * Set the value of the datapool item lastEvtEid_2 (Event identifier of the
 * last generated level 2 event report)
 * @param lastEvtEid_2 The value to be stored into the datapool item
 * lastEvtEid_2.
 */
static inline void setDplastEvtEid_2(CrPsEvtId_t lastEvtEid_2) {
   dpEvtVars.lastEvtEid_2 = lastEvtEid_2;
}

/**
 * Get the value of the datapool item lastEvtEid_3 (Event identifier of the
 * last generated level 3 event report)
 * @return The value of datapool item lastEvtEid_3
 */
static inline CrPsEvtId_t getDplastEvtEid_3() {
   return dpEvtVars.lastEvtEid_3;
}

/**
 * Set the value of the datapool item lastEvtEid_3 (Event identifier of the
 * last generated level 3 event report)
 * @param lastEvtEid_3 The value to be stored into the datapool item
 * lastEvtEid_3.
 */
static inline void setDplastEvtEid_3(CrPsEvtId_t lastEvtEid_3) {
   dpEvtVars.lastEvtEid_3 = lastEvtEid_3;
}

/**
 * Get the value of the datapool item lastEvtEid_4 (Event identifier of the
 * last generated level 4event report)
 * @return The value of datapool item lastEvtEid_4
 */
static inline CrPsEvtId_t getDplastEvtEid_4() {
   return dpEvtVars.lastEvtEid_4;
}

/**
 * Set the value of the datapool item lastEvtEid_4 (Event identifier of the
 * last generated level 4event report)
 * @param lastEvtEid_4 The value to be stored into the datapool item
 * lastEvtEid_4.
 */
static inline void setDplastEvtEid_4(CrPsEvtId_t lastEvtEid_4) {
   dpEvtVars.lastEvtEid_4 = lastEvtEid_4;
}

/**
 * Get the value of the datapool item lastEvtTime_1 (Time when the last level
...
/**
 * Set the value of the datapool item lastEvtTime_1 (Time when the last level
 * 1 event report was generated)
...
/**
 * Get the value of the datapool item lastEvtTime_2 (Time when the last level
...
/**
 * Set the value of the datapool item lastEvtTime_2 (Time when the last level
 * 2 event report was generated)
...
/**
 * Get the value of the datapool item lastEvtTime_3 (Time when the last level
...
/**
 * Set the value of the datapool item lastEvtTime_3 (Time when the last level
 * 3 event report was generated)
...
/**
 * Get the value of the datapool item lastEvtTime_4 (Time when the last level
...
/**
 * Set the value of the datapool item lastEvtTime_4 (Time when the last level
 * 4 event report was generated)
...
/**
 * Get the value of the datapool item nOfDetectedEvts_1 (Number of detected
 * occurrences of level 1 events)
 * @return The value of datapool item nOfDetectedEvts_1
 */
static inline CrPsNEvtRep_t getDpnOfDetectedEvts_1() {
   return dpEvtVars.nOfDetectedEvts_1;
}

/**
 * Set the value of the datapool item nOfDetectedEvts_1 (Number of detected
 * occurrences of level 1 events)
 * @param nOfDetectedEvts_1 The value to be stored into the datapool item
 * nOfDetectedEvts_1.
 */
static inline void setDpnOfDetectedEvts_1(CrPsNEvtRep_t nOfDetectedEvts_1) {
   dpEvtVars.nOfDetectedEvts_1 = nOfDetectedEvts_1;
}

/**
 * Get the value of the datapool item nOfDetectedEvts_2 (Number of detected
 * occurrences of level 2 events)
 * @return The value of datapool item nOfDetectedEvts_2
 */
static inline CrPsNEvtRep_t getDpnOfDetectedEvts_2() {
   return dpEvtVars.nOfDetectedEvts_2;
}

/**
 * Set the value of the datapool item nOfDetectedEvts_2 (Number of detected
 * occurrences of level 2 events)
 * @param nOfDetectedEvts_2 The value to be stored into the datapool item
 * nOfDetectedEvts_2.
 */
static inline void setDpnOfDetectedEvts_2(CrPsNEvtRep_t nOfDetectedEvts_2) {
   dpEvtVars.nOfDetectedEvts_2 = nOfDetectedEvts_2;
}

/**
 * Get the value of the datapool item nOfDetectedEvts_3 (Number of detected
 * occurrences of level 3 events)
 * @return The value of datapool item nOfDetectedEvts_3
 */
static inline CrPsNEvtRep_t getDpnOfDetectedEvts_3() {
   return dpEvtVars.nOfDetectedEvts_3;
}

/**
 * Set the value of the datapool item nOfDetectedEvts_3 (Number of detected
 * occurrences of level 3 events)
 * @param nOfDetectedEvts_3 The value to be stored into the datapool item
 * nOfDetectedEvts_3.
 */
static inline void setDpnOfDetectedEvts_3(CrPsNEvtRep_t nOfDetectedEvts_3) {
   dpEvtVars.nOfDetectedEvts_3 = nOfDetectedEvts_3;
}

/**
 * Get the value of the datapool item nOfDetectedEvts_4 (Number of detected
 * occurrences of level 4 events)
 * @return The value of datapool item nOfDetectedEvts_4
 */
static inline CrPsNEvtRep_t getDpnOfDetectedEvts_4() {
   return dpEvtVars.nOfDetectedEvts_4;
}

/**
 * Set the value of the datapool item nOfDetectedEvts_4 (Number of detected
 * occurrences of level 4 events)
 * @param nOfDetectedEvts_4 The value to be stored into the datapool item
 * nOfDetectedEvts_4.
 */
static inline void setDpnOfDetectedEvts_4(CrPsNEvtRep_t nOfDetectedEvts_4) {
   dpEvtVars.nOfDetectedEvts_4 = nOfDetectedEvts_4;
}

/**
 * Get the value of the datapool item nOfDisabledEid_1 (Number of event
 * identifiers of level 1 which are disabled)
 * @return The value of datapool item nOfDisabledEid_1
 */
static inline CrPsNEvtId_t getDpnOfDisabledEid_1() {
   return dpEvtVars.nOfDisabledEid_1;
}

/**
 * Set the value of the datapool item nOfDisabledEid_1 (Number of event
 * identifiers of level 1 which are disabled)
 * @param nOfDisabledEid_1 The value to be stored into the datapool item
 * nOfDisabledEid_1.
 */
static inline void setDpnOfDisabledEid_1(CrPsNEvtId_t nOfDisabledEid_1) {
   dpEvtVars.nOfDisabledEid_1 = nOfDisabledEid_1;
}

/**
 * Get the value of the datapool item nOfDisabledEid_2 (Number of event
 * identifiers of level 2 which are disabled)
 * @return The value of datapool item nOfDisabledEid_2
 */
static inline CrPsEvtId_t getDpnOfDisabledEid_2() {
   return dpEvtVars.nOfDisabledEid_2;
}

/**
 * Set the value of the datapool item nOfDisabledEid_2 (Number of event
 * identifiers of level 2 which are disabled)
 * @param nOfDisabledEid_2 The value to be stored into the datapool item
 * nOfDisabledEid_2.
 */
static inline void setDpnOfDisabledEid_2(CrPsEvtId_t nOfDisabledEid_2) {
   dpEvtVars.nOfDisabledEid_2 = nOfDisabledEid_2;
}

/**
 * Get the value of the datapool item nOfDisabledEid_3 (Number of event
 * identifiers of level 3 which are disabled)
 * @return The value of datapool item nOfDisabledEid_3
 */
static inline CrPsNEvtId_t getDpnOfDisabledEid_3() {
   return dpEvtVars.nOfDisabledEid_3;
}

/**
 * Set the value of the datapool item nOfDisabledEid_3 (Number of event
 * identifiers of level 3 which are disabled)
 * @param nOfDisabledEid_3 The value to be stored into the datapool item
 * nOfDisabledEid_3.
 */
static inline void setDpnOfDisabledEid_3(CrPsNEvtId_t nOfDisabledEid_3) {
   dpEvtVars.nOfDisabledEid_3 = nOfDisabledEid_3;
}

/**
 * Get the value of the datapool item nOfDisabledEid_4 (Number of event
 * identifiers of level 4 which are disabled)
 * @return The value of datapool item nOfDisabledEid_4
 */
static inline CrPsEvtId_t getDpnOfDisabledEid_4() {
   return dpEvtVars.nOfDisabledEid_4;
}

/**
 * Set the value of the datapool item nOfDisabledEid_4 (Number of event
 * identifiers of level 4 which are disabled)
 * @param nOfDisabledEid_4 The value to be stored into the datapool item
 * nOfDisabledEid_4.
 */
static inline void setDpnOfDisabledEid_4(CrPsEvtId_t nOfDisabledEid_4) {
   dpEvtVars.nOfDisabledEid_4 = nOfDisabledEid_4;
}

/**
 * Get the value of the datapool item nOfGenEvtRep_1 (Number of generated
 * level 1 event reports)
 * @return The value of datapool item nOfGenEvtRep_1
 */
static inline CrPsNEvtRep_t getDpnOfGenEvtRep_1() {
   return dpEvtVars.nOfGenEvtRep_1;
}

/**
 * Set the value of the datapool item nOfGenEvtRep_1 (Number of generated
 * level 1 event reports)
 * @param nOfGenEvtRep_1 The value to be stored into the datapool item
 * nOfGenEvtRep_1.
 */
static inline void setDpnOfGenEvtRep_1(CrPsNEvtRep_t nOfGenEvtRep_1) {
   dpEvtVars.nOfGenEvtRep_1 = nOfGenEvtRep_1;
}

/**
 * Get the value of the datapool item nOfGenEvtRep_2 (Number of generated
 * level 2 event reports)
 * @return The value of datapool item nOfGenEvtRep_2
 */
static inline CrPsNEvtRep_t getDpnOfGenEvtRep_2() {
   return dpEvtVars.nOfGenEvtRep_2;
}

/**
 * Set the value of the datapool item nOfGenEvtRep_2 (Number of generated
 * level 2 event reports)
 * @param nOfGenEvtRep_2 The value to be stored into the datapool item
 * nOfGenEvtRep_2.
 */
static inline void setDpnOfGenEvtRep_2(CrPsNEvtRep_t nOfGenEvtRep_2) {
   dpEvtVars.nOfGenEvtRep_2 = nOfGenEvtRep_2;
}

/**
 * Get the value of the datapool item nOfGenEvtRep_3 (Number of generated
 * level 3 event reports)
 * @return The value of datapool item nOfGenEvtRep_3
 */
static inline CrPsNEvtRep_t getDpnOfGenEvtRep_3() {
   return dpEvtVars.nOfGenEvtRep_3;
}

/**
 * Set the value of the datapool item nOfGenEvtRep_3 (Number of generated
 * level 3 event reports)
 * @param nOfGenEvtRep_3 The value to be stored into the datapool item
 * nOfGenEvtRep_3.
 */
static inline void setDpnOfGenEvtRep_3(CrPsNEvtRep_t nOfGenEvtRep_3) {
   dpEvtVars.nOfGenEvtRep_3 = nOfGenEvtRep_3;
}

/**
 * Get the value of the datapool item nOfGenEvtRep_4 (Number of generated
 * level 4 event reports)
 * @return The value of datapool item nOfGenEvtRep_4
 */
static inline CrPsNEvtRep_t getDpnOfGenEvtRep_4() {
   return dpEvtVars.nOfGenEvtRep_4;
}

/**
 * Set the value of the datapool item nOfGenEvtRep_4 (Number of generated
 * level 4 event reports)
 * @param nOfGenEvtRep_4 The value to be stored into the datapool item
 * nOfGenEvtRep_4.
 */
static inline void setDpnOfGenEvtRep_4(CrPsNEvtRep_t nOfGenEvtRep_4) {
