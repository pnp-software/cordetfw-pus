 ...
 * @ingroup gen_cfw
 *
 * Implementation of TC(11,23) ScdDelGrpCmd as an incoming command.
 *
...
#include "CrPsInCmdScdDelGrpCmd.h"
 ...
 */
void CrPsInCmdScdDelGrpCmdStartAction(FwSmDesc_t smDesc)
{
   CRFW_UNUSED(smDesc);
   DBG("CrPsInCmdScdDelGrpCmdStartAction");
   return ;
}
 ...
 * @param smDesc The state machine descriptor.
 */
void CrPsInCmdScdDelGrpCmdProgressAction(FwSmDesc_t smDesc)
{
   CRFW_UNUSED(smDesc);
   DBG("CrPsInCmdScdDelGrpCmdProgressAction");
   return ;
}
