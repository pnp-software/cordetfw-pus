 ...
 * @ingroup gen_cfw
 *
 * Implementation of TC(11,4) ScdInsTbaCmd.
 *
 ...
 */
void CrPsScdInsTbaCmdStartAction(FwSmDesc_t smDesc)
{
   CRFW_UNUSED(smDesc);
   DBG("CrPsScdInsTbaCmdStartAction");
   return 1;
}
 ...
 * @param smDesc The state machine descriptor.
 */
void CrPsScdInsTbaCmdProgressAction(FwSmDesc_t smDesc)
{
   CRFW_UNUSED(smDesc);
   DBG("CrPsScdInsTbaCmdProgressAction");
   return 1;
}
