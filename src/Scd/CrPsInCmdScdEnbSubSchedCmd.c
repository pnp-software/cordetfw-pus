 ...
 * @ingroup gen_cfw
 *
 * Implementation of TC(11,20) ScdEnbSubSchedCmd as an incoming command.
 *
...
#include "CrPsInCmdScdEnbSubSchedCmd.h"
 ...
 */
void CrPsInCmdScdEnbSubSchedCmdStartAction(FwSmDesc_t smDesc)
{
   CRFW_UNUSED(smDesc);
   DBG("CrPsInCmdScdEnbSubSchedCmdStartAction");
   return ;
}
 ...
 * @param smDesc The state machine descriptor.
 */
void CrPsInCmdScdEnbSubSchedCmdProgressAction(FwSmDesc_t smDesc)
{
   CRFW_UNUSED(smDesc);
   DBG("CrPsInCmdScdEnbSubSchedCmdProgressAction");
   return ;
}
