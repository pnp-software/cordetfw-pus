 ...
 */
void CrPsInCmdScdDisGrpCmdStartAction(FwSmDesc_t smDesc)
{
   CRFW_UNUSED(smDesc);
   DBG("CrPsInCmdScdDisGrpCmdStartAction");
   return ;
}
 ...
 * @param smDesc The state machine descriptor.
 */
void CrPsInCmdScdDisGrpCmdProgressAction(FwSmDesc_t smDesc)
{
   CRFW_UNUSED(smDesc);
   DBG("CrPsInCmdScdDisGrpCmdProgressAction");
   return ;
}
